    ...
    internal static class Test
    {
        ...
        private static void TestInterpreter()
        {
            InterpreterTest[] tests =
            {
                ...
                new InterpreterTest("3", 3),
                new InterpreterTest("+ 5", 5),
                new InterpreterTest("2 + 5 - 3", 4),
                new InterpreterTest("3 * (2 + 6) - 3", 21),
                new InterpreterTest("6 * (-3 - - 6) / 3 + 7", 13),
            };
        ...
        private static void TestLexer()
        {
            InterpreterTest[] tests =
            {
                ...
                new InterpreterTest("(", TokenType.LeftParens),
                new InterpreterTest(")", TokenType.RightParens),
